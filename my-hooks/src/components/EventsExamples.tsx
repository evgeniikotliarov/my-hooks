...
const EventsExamples: FC = () => {
  ...
  return (
    <div>
      ...
      <div onDrag={dragHandler} draggable style={{width: "200px", height: "200px", backgroundColor: "green"}}></div>
      <div
        onDrop={dropHandler}
        onDragLeave={leaveHandler}
        onDragOver={dragWidthPreventHandler}
        style={{width: "200px", height: "200px", backgroundColor: isDrag ? "red" : "blue", marginTop: "50px"}}></div>
    </div>
  );
};
